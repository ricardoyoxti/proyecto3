...
# Función para crear usuario de base de datos para Odoo
create_odoo_db_user() {
    print_step "Creando usuario de base de datos para Odoo..."
    
    sudo -u postgres createuser -s $ODOO_USER 2>/dev/null || true
    
    print_message "Usuario de base de datos creado"
}
